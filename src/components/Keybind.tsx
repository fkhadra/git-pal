...
export function Kbd({ children }: { children: React.ReactNode }) {
  return (
    <kbd className="inline-flex max-h-5 w-fit min-w-5 items-center justify-center rounded-sm border border-pink-300/40 bg-zinc-900 p-1 text-sm text-pink-200">
      {children}
    </kbd>
  );
}
