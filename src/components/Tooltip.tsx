...
interface TooltipProps {
  children:
    ...
    | ComponentRenderFn<HTMLProps<any>, TooltipTriggerState>
    | undefined;
  ...
  return (
    <svg width="20" height="10" viewBox="0 0 20 10" fill="none" {...props}>
      <path
        ...
        className="fill-[canvas] dark:fill-zinc-950"
      />
      <path
