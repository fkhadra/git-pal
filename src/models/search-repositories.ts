...
export type ResponseData = { search: SearchRepositoriesSearch, };

export type SearchRepositoriesSearch = { nodes: Array<SearchRepositoriesSearchNodes | null> | null, };

export type SearchRepositoriesSearchNodes = { "__typename": "App" } | { "__typename": "Discussion" } | { "__typename": "Issue" } | { "__typename": "MarketplaceListing" } | { "__typename": "Organization" } | { "__typename": "PullRequest" } | { "__typename": "Repository" } & Repository | { "__typename": "User" };
